...
void InitExeAddress()
{
	ExecuteCommand = RVA <_ExecuteCommand>(
		"ExecuteCommand", {
			{ RUNTIME_VR_VERSION_1_2_72, 0x012DC460 },
...
void InitAddresses()
{
	...
	LevelupMenuPlayPerkSound = RVA <_LevelupMenuPlayPerkSound>(
		"LevelupMenuPlayPerkSound", {
			{ RUNTIME_VR_VERSION_1_2_72, 0x00B5BBE0 },
		}, "48 89 5C 24 08 57 48 83 EC 30 48 8B F9 8B CA 33 DB E8 ? ? ? ? 48 85 C0 74 ? 80 78 1A 5F 75 ? 48 8B 98 88 00 00 00 48 81 C7 98 01 00 00");
	BSSoundHandle__Stop = RVA <_BSSoundHandle__Stop>(
		"BSSoundHandle__Stop", {
			{ RUNTIME_VR_VERSION_1_2_72, 0x01B4AA90 },
		}, "40 53 48 83 EC 20 8B 19 83 FB FF 74 ? C6 41 05 02");
	g_PipboyDataManager = RVA <PipboyDataManager*>(
		"g_PipboyDataManager", {
			{ RUNTIME_VR_VERSION_1_2_72, 0x045932578 },
		}, "48 8B 0D ? ? ? ? 48 8D 44 24 48 48 8D 54 24 20 48 89 44 24 20 48 8D 44 24 50 48 81 C1 F0 08 00 00 ", 0, 3, 7);
	BGSAudio__GetSoundDescriptor = RVA <_BGSAudio__GetSoundDescriptor>(
		"_BGSAudio__GetSoundDescriptor", {
			{ RUNTIME_VR_VERSION_1_2_72, 0x0081FDE0 },
	...
	BSAudioManager__GetSoundHandle = RVA <_BSAudioManager__GetSoundHandle>(
		"_BSAudioManager__GetSoundHandle", {
				{ RUNTIME_VR_VERSION_1_2_72, 0x01B4CF50 },
	...
	BSSoundHandle__Play = RVA <_BSSoundHandle__Play>(
		"_BSSoundHandle__Play", {
				{ RUNTIME_VR_VERSION_1_2_72, 0x01B4A9C0 },
		}, "40 53 48 83 EC 20 8B 19 83 FB FF 74 ? C6 41 05 01");
	BSAudioManager_instance = RVA <void*>(
		"BSAudioManager_instance", {
				{ RUNTIME_VR_VERSION_1_2_72, 0x05B6DB90 },
...
void InitUIManager()
{
	UI_AddMessage = RVA <_UI_AddMessage>(
		"UI_AddMessage", {
			{ RUNTIME_VR_VERSION_1_2_72, 0x020D69E0 },
	...
	g_UIManager = RVA <void*>(
		"g_UIManager", {
			{ RUNTIME_VR_VERSION_1_2_72, 0x05932558 },
...
UInt8 GetPerkPoints()
{
	UInt8 ppts = Utils::GetOffset<UInt8>(*g_player, 0x1161);
...
{
	UInt16 spts = Utils::GetOffset<UInt16>(*g_player, 0x1164);
...
{
	UInt8 result = Utils::GetOffset<UInt8>(*g_player, 0x1167);
...
{
	UInt8* status = Utils::GetOffsetPtr<UInt8>(*g_player, 0x1167);
	*status = started;
}
