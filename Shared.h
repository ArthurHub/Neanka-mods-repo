...
public:
	...
	UInt64									unkE8[(0x198 - 0xE8) / 8];			// E8
	SInt32									playingSoundHandle;								// 198
};
STATIC_ASSERT(sizeof(LevelUpMenu) == 0x1A0);
...
typedef UInt8(*_LevelupMenuPlayPerkSound)(LevelUpMenu * menu, UInt32 formid);
...
typedef UInt8(*_BSSoundHandle__Stop)(SInt32* soundHandle);		// unk1 is LevelUpMenu+0x180
extern RVA <_BSSoundHandle__Stop> BSSoundHandle__Stop;	// 0x01AC7B70 // 40 53 48 83 EC 20 8B 19 83 FB FF 74 ? C6 41 05 02

typedef TESForm*(*_BGSAudio__GetSoundDescriptor)(const char* name);
extern RVA <_BGSAudio__GetSoundDescriptor> BGSAudio__GetSoundDescriptor; // 40 53 48 83 EC 20 E8 ?? ?? ?? ?? 48 8B D8 33 C0


typedef void(*_BSAudioManager__GetSoundHandle)(void* audioManager_instance, SInt32* soundHandle, void* soundDescriptor, float param4, UInt32 param5, void** extraResolutionData);
extern RVA <_BSAudioManager__GetSoundHandle> BSAudioManager__GetSoundHandle; //48 8B C4 48 89 58 08 48 89 68 10 48 89 70 18 57 41 54 41 55 41 56 41 57 48 81 EC A0 00 00 00 44 8B 0D ? ? ? ?

typedef void(*_BSSoundHandle__Play)(SInt32* soundHandle);
extern RVA <_BSSoundHandle__Play> BSSoundHandle__Play; //40 53 48 83 EC 20 8B 19 83 FB FF 74 ? C6 41 05 01

extern RVA <void*> BSAudioManager_instance;
