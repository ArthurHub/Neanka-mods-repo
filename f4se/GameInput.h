...
{
public:
	UInt32 stick; // b - left, c - right
	UInt32 unk34;
	float x;
	float y;
	UInt32 previousDirection; // 1 - top, 2 - right, 3 - bottom, 4 - left
	UInt32 direction; // 1 - top, 2 - right, 3 - bottom, 4 - left
};
...
public:
	...
	virtual void OnTouchpadEvent(void* hz) { };
	virtual void Unk02(void* hz) { };
	virtual void Unk03(void* hz) { };
