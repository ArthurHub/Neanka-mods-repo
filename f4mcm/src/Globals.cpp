...
namespace G
{
    ...
    void Init()
    {
        scaleformManager    = RVA<BSScaleformManager*>  (GET_RVA(g_scaleformManager),   "48 8B 0D ? ? ? ? 48 8D 05 ? ? ? ? 0F 57 C0 F3 0F 11 44 24 30 4C 8D 43 40 4C 8D 0D ? ? ? ? 48 8B D3 C7 44 24 28 03 00 00 00", 0, 3, 7);
        menuControls        = RVA<MenuControls*>        (GET_RVA(g_menuControls),       "48 8B 0D ? ? ? ? 40 32 FF E8 ? ? ? ? 40 38 3D ? ? ? ?", 0, 3, 7);
